...
class PurePursuit(Node):
    ...
    def pose_callback(self, pose_msg):
        ...
        # print("Base Link: ", round(goal_point_base_link.x, 2),
        #       round(goal_point_base_link.y, 2))
        # print("Goal Point: ", round(self.goal_point_map.x, 2), round(self.goal_point_map.y, 2))
        # print("transform: ", round(transformation.transform.translation.x, 2), round(transformation.transform.translation.y, 2))

        # Calculate curvature/steering angle
        curvature = 2 * goal_point_base_link.y / self.L ** 2
        ...
        drive_msg.header.stamp = pose_msg.header.stamp
        drive_msg.header.frame_id = pose_msg.header.frame_id
